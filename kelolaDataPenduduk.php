...
$penduduk = query("SELECT * FROM penduduk WHERE status = 1");
?>
...
<body>
    ...
    <main>
        <div class="container" style="margin-top: 100px;">
            <h2 style="padding: 15px 0 30px 0" class="font-weight-light">Daftar Data Penduduk <span style="font-weight: bold;">Kopandakan 2</span></h2>
        </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $p['nama'] ?></td>
                            <td>
                                <a href="detailDataPenduduk.php?nik=<?= $p['nik'] ?>" class="btn-lihat-detail">Lihat Detail</a>
                            </td>
                        </tr>
